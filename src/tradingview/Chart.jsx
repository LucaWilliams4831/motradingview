...
const Chart = (props) => {
  const { symbol, tokenId, interval, width, height, status, pairAddress } = props;
  ...
  console.log(isBook, isMobile, chartHeight, chartWidth)
  ...
  useEffect(() => {
    if (symbol && interval) {
      const widget = (window.tvWidget = new TradingView.widget({
        ...
        datafeed: Datafeed(tokenId, pairAddress),
